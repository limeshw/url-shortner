...
app.use(  //always use the session after the cookie-parser and before authentication middleware , beacuse aftr setting cookie we are going to create session
...
app.use((req, res, next) => { //it's explanation is below
